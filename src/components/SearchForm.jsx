  ...
  return (
    <>
      <div className="bg-gradient-to-r from-blue-500 to-purple-500  p-4 shadow-2xl rounded-xl m-4">
        <h1 className="text-center text-2xl font-extrabold text-neutral-200 mb-4">Movie and game search engine</h1>
        <form onSubmit={handleSubmit} className="flex flex-col md:flex-row items-center">
          <input
            ...
            className="p-2 border rounded m-2 text-neutral-100 cursor-pointer"
          />
          <input
            type="text"
          ...
          <button type="submit" className="p-2 bg-blue-500 text-white rounded m-2 cursor-pointer">
            Search
          </button>
        </form>
      </div>
